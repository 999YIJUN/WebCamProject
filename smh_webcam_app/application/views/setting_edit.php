    ...
    <main class="form-setting flex-grow-1 my-5">
        <form method="post" action="<?php echo base_url('setting/update'); ?>">
            <div class="mb-3">
                ...
                <input type="text" name="id" class="form-control form-control-lg" value="<?php echo $setting['id']; ?>" readonly id="formGroupExampleInput">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">URL:</label>
                <input type="text" name="url" class="form-control form-control-lg" value="<?php echo $setting['url']; ?>" id="formGroupExampleInput2">
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="window.location.href='<?php echo base_url('setting/edit/' . $encoded_id); ?>'"></button>
                        </div>
                        <div class="modal-body">
                            <?php echo $this->session->flashdata('error_message'); ?>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal" onclick="window.location.href='<?php echo base_url('setting/edit/' . $encoded_id); ?>'">關閉</button>
                        </div>
                    </div>
                </div>
            </div>
